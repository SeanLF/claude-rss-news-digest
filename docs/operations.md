...
make digest-start DATE=2026-09-24 # a fresh day: sends at once if its pre-send checks pass
make digest-approve DATE=2026-09-24   # or digest-reject, while a flagged run holds; unsignalled, it sends after 15 min

...
reviewed step that forces re-checking them (``feedback_canary_dep_workarounds``):
  ...
  Re-verified live on 0.2.153 (``bin/sdk-canary``, 2026-09-16): thinking-disabled is still ACCEPTED on
  ...
  here and is not a reason to hold the pin.
...
_WORKAROUNDS_VALIDATED_THROUGH = "0.2.153"

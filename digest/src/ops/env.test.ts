...
const FULL = { HEALTH_ALERT_EMAIL: "ops@x", RESEND_API_KEY: "re", RESEND_FROM: "d@x", HEALTHCHECK_PING_URL: "https://hc-ping.com/u", BROADCAST_ENABLED: "true", RESEND_AUDIENCE_ID: "aud" };

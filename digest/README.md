...
make digest-start DATE=2026-09-24      # start one DigestWorkflow; it sends at once, or holds 15 min if a pre-send check fails
make digest-approve DATE=2026-09-24    # or digest-reject, during a hold; the send lands in resend-fake, never Resend
